...
`googlechart` is a sibling — not a replacement — for [sparkta2]([https://github.com/ericbooth/sparkta2-stata-public](https://github.com/ericabooth/Sparkta2_Example_Site)). Both produce self-contained interactive HTML from Stata; they target different use cases.
